...
Official non-TypeScript and mobile Checkout SDKs live under [`sdks/`](./sdks) (Python, Go, PHP, Java, .NET, iOS, Android, Flutter, React Native). WooCommerce gateway: [`integrations/woocommerce`](./integrations/woocommerce). See [Languages and SDKs](https://docs.autlantic.com/guide/languages).

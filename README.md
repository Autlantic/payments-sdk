...
Official non-TypeScript and mobile Checkout SDKs live under [`sdks/`](./sdks) (Python, Go, PHP, Java, iOS, Android). See [Languages and SDKs](https://docs.autlantic.com/guide/languages).

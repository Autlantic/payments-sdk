...
Billing is the coupon source of truth for portal and Autlantic creator UI. Hosted checkout resolves codes from the same store (`scopeKey` prefers scoped, then merchant-wide). See [Coupons](/guide/coupons).
